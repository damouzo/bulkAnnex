process SINGULARITY_PULL {
    ...
    script:
    def sif   = params.container        // full SIF path — set by singularity profile in nextflow.config
    def image = params.container_docker // DockerHub pull source — set in params block in nextflow.config
